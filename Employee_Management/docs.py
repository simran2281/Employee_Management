...
class Employee:
    def __init__(self,root):
        ...
        lbl_title=Label(self.root,text='EMPLOYEE MANAGEMENT SYSTEM',font=('times new roman',37,'bold'),fg='#a86932',bg='white')
        lbl_title.place(x=0,y=0,width=1530,height=50)

        img_logo=Image.open('col_images/emplogo.jpg')
        ...
        img1=Image.open('col_images/teamwork1.jpg')
        ...
        img2=Image.open('col_images/teamwork2.png')
        ...
        img3=Image.open('col_images/teamwork3.png')
        ...
        upper_frame=LabelFrame(Main_frame,bd=2,relief=RIDGE,bg='white', text='Employee Information', font=('times new roman',12,'bold'),fg='#eb822d')
        ...
        lbl_dep=Label(upper_frame,text='Department',font=('times new roman',12,'bold'),bg='white')
        ...
        lbl_Desiginition=Label(upper_frame,font=('arial',12,'bold'),text="Desigintion:",bg='white')
        lbl_Desiginition.grid(row=1,column=0,sticky=W,padx=2,pady=7)

        txt_Desigintion=ttk.Entry(upper_frame,textvariable=self.var_designation,width=22,font=('arial',12,'bold'))
        txt_Desigintion.grid(row=1,column=1,padx=2,pady=7)
        ...
        com_txt_proof=ttk.Entry(upper_frame,textvariable=self.var_idproof,width=22,font=('arial',12,'bold'))
        com_txt_proof.grid(row=4,column=1,padx=2,pady=7)


        # Gender

        lbl_gender_status=Label(upper_frame,font=('arial',12,'bold'),text="Gender:",bg='white')
        lbl_gender_status.grid(row=4,column=2,sticky=W,padx=2,pady=7)
        ...
        down_frame=LabelFrame(Main_frame,bd=2,relief=RIDGE,bg='white', text='Employee Information Table', font=('times new roman',12,'bold'),fg='#eb822d')
        down_frame.place(x=10,y=280,width=1480,height=270)

        # mast image

        img4=Image.open('col_images/face.jpg')
        ...
        btn_add=Button(button_frame,text="Save",command=self.add_data,font=('arial',15,'bold'),width=13,bg='black',fg='white')
        btn_add.grid(row=0,column=0,padx=1,pady=5)

        btn_update=Button(button_frame,text="Update",command=self.update_data,font=('arial',15,'bold'),width=13,bg='black',fg='white')
        btn_update.grid(row=1,column=0,padx=1,pady=5)

        btn_delete=Button(button_frame,text="Delete",command=self.delete_data,font=('arial',15,'bold'),width=13,bg='black',fg='white')
        btn_delete.grid(row=2,column=0,padx=1,pady=5)

        btn_clear=Button(button_frame,text="Clear",command=self.reset_data,font=('arial',15,'bold'),width=13,bg='black',fg='white')
       ...
       #Search Frame
        ...
        search_frame=LabelFrame(down_frame,bd=2,relief=RIDGE,bg='white',text='Search Employee Information',font=('times new roman',12,'bold'),fg='#eb822d')
        ...
        btn_search=Button(search_frame,command=self.search_data,font=("arial",11,"bold"),text="Search",width=14,fg="white",bg="red")
        btn_search.grid(row=0,column=3,padx=5)

        btn_ShowAll=Button(search_frame,command=self.fetch_data,font=("arial",11,"bold"),text="Show All",width=14,fg="white",bg="red")
        btn_ShowAll.grid(row=0,column=4,padx=5)

        stayhome=Label(search_frame,font=('arial',30,'bold'),text="Wear a Mask",bg='white')
        stayhome.place(x=780,y=0,width=600,height=30)

        img_mask=Image.open('col_images/mask.jpg')
        img_mask=img_mask.resize((150,50),Image.Resampling.LANCZOS)
        self.photoimg_mask=ImageTk.PhotoImage(img_mask)


        self.im=Label(search_frame,image=self.photoimg_mask)
        self.im.place(x=900,y=0,width=50,height=30)
        ...
        tabel_frame.place(x=0,y=60,width=1470,height=170)
        
        Scroll_x=ttk.Scrollbar(tabel_frame,orient=HORIZONTAL)
        Scroll_y=ttk.Scrollbar(tabel_frame,orient=VERTICAL)

        self.employee_table=ttk.Treeview(tabel_frame,column=("dep","name","degi","email","address","married","dob","doj","idproofcomb","idproof","gender","phone","country","salary",),xscrollcommand=Scroll_x.set,yscrollcommand=Scroll_y.set)
    ...
    def add_data(self):
        if self.var_dep.get()=="" or self.var_email.get()=="":
            ...
            try:
                conn=mysql.connector.connect(host='localhost',username='root',password='pranjal_0801',database='mydata')
    ...
    def update_data(self):
        if self.var_dep.get()=="" or self.var_email.get()=="":
            ...
            try:
                ...
                self.fetch_data()
                conn.close()
                messagebox.showinfo('success','Employee data succesfully updated',parent=self.root)
            except Exception as es:
                messagebox.showerror('Error',f'Due To:{str(es)}',parent=self.root)
    #Delete
    ...
    def delete_data(self):
        if self.var_idproof.get()=="":
            ...
            try:
                ...
                self.fetch_data()
                conn.close() 
                messagebox.showinfo('Delete','Employee data succesfully Deleted',parent=self.root)
            except Exception as es:
                messagebox.showerror('Error',f'Due To:{str(es)}',parent=self.root)
